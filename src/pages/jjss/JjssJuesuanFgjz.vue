    ...
    export default {
        ...
        data() {
            return {
                ...
                loadingJbxx: false,
                finishedJbxx: false,
                apiUrlJbxx: this.GLOBAL.serverSrc+'/zhspJjss/getJjssJuesuanJbxxById.do',
                zlscs: [],
                loadingZlscs: false,
                finishedZlscs: false,
                ...
                loadingZjgss: false,
                finishedZjgss: false,
                apiUrlZjgss: this.GLOBAL.serverSrc+'/zhspJjss/getZjgsByJuesuanId.do',
                tzxmjss: [],
                ...
                loadingHiss: false,
                finishedHiss: false,
                apiUrlOperate: this.GLOBAL.serverSrc+'/zhspJjss/doTaskJuesuan.do',
                show: false,
                value:"",
        ...
        methods: {
                ...
                this.$dialog.confirm({
                    ...
                    this.$http.get(this.apiUrlOperate,{
                        params: {businessId:businessId,taskId:taskId,
                            opinion:this.value,submitType:"back",opFunction:"jjssJuesuanfgjzSpOperate"}
            ...
            onClickPass(){
                ...
                this.$dialog.confirm({
                    ...
                    this.$http.get(this.apiUrlOperate,{
                        params: {businessId:businessId,taskId:taskId,
                            opinion:this.value,submitType:"pass",opFunction:"jjssJuesuanfgjzSpOperate"}
                    }).then(function(response) {
                        if("SUCCESS"==response.bodyText){
                            this.$toast.success('提交成功！');
                            window.top.location.href="/#/todo";
            ...
            onLoadZlscs() {
                let businessId = this.$route.query.businessId;
                this.$http.get(this.apiUrlZlscs,{params: {businessId:businessId,type:'zlsc',sslx:'juesuan'}}).then(function(response) {
            ...
            onLoadTzxmjss() {
                let businessId = this.$route.query.businessId;
                this.$http.get(this.apiUrlTzxmjss,{params: {businessId:businessId,type:'jjssTzxmjs',sslx:'juesuan'}}).then(function(response) {
