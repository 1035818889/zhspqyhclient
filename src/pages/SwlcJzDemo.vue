                ...
                <van-swipe ref="item" :loop="false" :show-indicators="false" :touchable="false">
                    <van-swipe-item>
                        <van-panel>
                            <div>
                                <van-cell-group>
                                    <van-cell title="标题"  label="关于安排行政事业性资产物业管理相关费用的请示" />
                                    <van-cell title="文件类型"  value="报字件" />
                                    <van-cell title="来文单位"  value="区国资局" />
                                    <van-cell title="文件字号"  value="三国资请[2019]64号" />
                                    <van-cell title="政府文号"  value="201909770" />
                                    <van-cell title="收文日期"  value="2019-11-08" />
                                    <van-cell title="办文期限"  value="2019-11-11" />
                                    <van-cell title="紧急程度"  value="特急" />
                                    <van-cell title="密级"  value="公开" />
                                    <van-cell title="主办部门"  value="行政事业科" />
                                    <van-cell title="办理部门"  label="行政事业科" />
                                </van-cell-group>
                            </div>
                        </van-panel>
                    </van-swipe-item>
    ...
    3、对征求意见稿其他内容无修改意见。" />
        ...
        <van-goods-action safe-area-inset-bottom style="width: 100%;">
            <van-row style="width: 100%;">
                <van-col span="4">
                    <van-goods-action-button style="border-top-left-radius: 10px;border-bottom-left-radius: 10px;" type="warning" text="退回" @click="onClickBack" />
                </van-col>
                <van-col span="11">
