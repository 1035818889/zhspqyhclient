    ...
    <div>
        ...
        <van-goods-action safe-area-inset-bottom style="width: 100%;/*margin-bottom: 55px;*/">
            <van-row style="width: 100%;">
                ...
                <van-col span="8">
                    <van-goods-action-button style="" type="info" text="办结确认" @click="onClickSendBjqr" />
                </van-col>
                <van-col span="8">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            onClickSendJz(){
                this.submitType = "sendJz";
                this.popupShow = true;
            },
            onClickSendBjqr(){
                this.submitType = "sendBjqr";
                this.popupShow = true;
            },
            onClickSubmit(){
                let yj = this.value;
                ...
                this.$dialog.confirm({
                    ...
                    this.$http.get(this.apiUrlOperate,{
                        params: {businessId:businessId,taskId:taskId,
                            opinion:this.value,submitType:this.submitType,opFunction:"zbksfgjzspOperate"}
