    ...
    <div>
        ...
        <van-goods-action safe-area-inset-bottom style="width: 100%;">
            <van-row style="width: 100%;">
                <van-col span="8">
                    <van-goods-action-button style="border-top-left-radius: 10px;border-bottom-left-radius: 10px;margin-left:0px" type="warning" text="回退主办股室" @click="onClickBackV2" />
                </van-col>
                <van-col span="8">
                    <van-goods-action-button style="" type="info" text="填写意见" @click="onClickTxyj" />
                </van-col>
                <van-col span="8">
                    <van-goods-action-button style="border-top-right-radius: 10px;border-bottom-right-radius: 10px;" type="info" text="提交分管领导" @click="onClickPassV2" />
                </van-col>
            </van-row>
        </van-goods-action>
        ...
        methods: {
                ...
                this.$dialog.confirm({
                    ...
                    this.$http.get(this.apiUrlOperate,{
                        params: {businessId:businessId,taskId:taskId,
                            opinion:this.value,submitType:"back",opFunction:"yskKzOperate"}
            ...
            onClickPass(){
                this.$dialog.confirm({
                    ...
                    this.$http.get(this.apiUrlOperate,{
                        params: {businessId:businessId,taskId:taskId,
                            opinion:this.value,submitType:"pass",opFunction:"yskKzOperate"}
                    }).then(function(response) {
                        if("SUCCESS"==response.bodyText){
                            this.$toast.success('提交成功！');
                            window.top.location.href="/";
            ...
            onLoadJbxx() {
                ...
                let taskId = this.$route.query.taskId;
                this.$http.get(this.apiUrlCurrentYj,{params: {businessId:businessId,taskId:taskId,type:'4',isYsk:"isYsk"}}).then(function(response) {
            ...
            onLoadSwyj() {
                ...
                let taskId = this.$route.query.taskId;
                this.$http.get(this.apiUrlCurrentKs,{params: {taskId:taskId,isYsk:"isYsk"}}).then(function(response) {
            ...
            onSaveYj() {
                ...
                this.$http.get(this.apiUrlSaveYj,{params: {businessId:businessId,taskId:taskId,type:'4',yj:yj,isYsk:"isYsk"}}).then(function(response) {
                    if("SUCCESS"==response.bodyText){
                        this.$toast.success('提交成功！');
