        ...
        methods: {
                ...
                this.$dialog.confirm({
                    ...
                    this.$http.get(this.apiUrlOperate,{
                        params: {businessId:businessId,taskId:taskId,
                            opinion:this.value,submitType:"back",opFunction:"yskfgjzOperate"}
            ...
            onClickPass(){
                this.$dialog.confirm({
                    ...
                    this.$http.get(this.apiUrlOperate,{
                        params: {businessId:businessId,taskId:taskId,
                            opinion:this.value,submitType:"pass",opFunction:"yskfgjzOperate"}
                    }).then(function(response) {
                        if("SUCCESS"==response.bodyText){
                            this.$toast.success('提交成功！');
                            window.top.location.href="/";
            ...
            onLoadJbxx() {
                ...
                let taskId = this.$route.query.taskId;
                this.$http.get(this.apiUrlCurrentYj,{params: {businessId:businessId,taskId:taskId,type:'5',isYsk:"isYsk"}}).then(function(response) {
            ...
            onSaveYj() {
                ...
                this.$http.get(this.apiUrlSaveYj,{params: {businessId:businessId,taskId:taskId,type:'5',yj:yj,isYsk:"isYsk"}}).then(function(response) {
                    if("SUCCESS"==response.bodyText){
                        this.$toast.success('提交成功！');
