        ...
        methods: {
                ...
                this.$dialog.confirm({
                    ...
                    this.$http.get(this.apiUrlOperate,{
                        params: {businessId:businessId,taskId:taskId,
                            opinion:this.value,submitType:"back",opFunction:"keShiAdjustFgjzspSubmit"}
            ...
            onClickPass(){
                this.$dialog.confirm({
                    ...
                    this.$http.get(this.apiUrlOperate,{
                        params: {businessId:businessId,taskId:taskId,
                            opinion:this.value,submitType:"pass",opFunction:"keShiAdjustFgjzspSubmit"}
                    }).then(function(response) {
                        if("SUCCESS"==response.bodyText){
                            this.$toast.success('提交成功！');
                            window.top.location.href="/#/todo";
            ...
            onSaveYj() {
                ...
                this.$http.get(this.apiUrlSaveYj,{params: {businessId:this.ksyjAdjust[0].wjysId,taskId:taskId,type:'2',yj:yj,isKsyjAdjust:'isKsyjAdjust'}}).then(function(response) {
                    if("SUCCESS"==response.bodyText){
                        this.$toast.success('提交成功！');
